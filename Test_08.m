% Test_08.m
% Results_08.mat - Workspace variables generated by this experiment
%
% Variable parameters settings compared using this test:
%
% hidden layer transfer functions = only 2 possible functions
% network topology - 20 different hidden layer combinations
%
% Fixed parameters for this test:
%
% target dataset size for experiment = 100000 (May be less due to rounding)
...
hiddenLayerSizes = {[20]; [30]; [40]; [50]; [60]; [70]; ...
                    [10 10]; [15 15]; [20 20]; [25 25]; [30 30]; [35 35]; ...
                    [13 13 13]; [15 15 15]; [20 20 20]; [25 25 25];
