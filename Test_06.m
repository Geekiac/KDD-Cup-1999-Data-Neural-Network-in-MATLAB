% Test_06.m
% Results_06.mat - Workspace variables generated by this experiment
%
% Variable parameters settings compared using this test:
%
% hidden layer transfer functions = only 4 possible functions
% network topology - 12 different hidden layer combinations
%
% Fixed parameters for this test:
%
% target dataset size for experiment = 50000 (May be less due to rounding)
...
hiddenLayerSizes = {[5]; [10]; [20]; [30]; ...
                    [5 5]; [10 10]; [15 15]; [20 20]; ...
                    [5 5 5]; [7 7 7]; [10 10 10]; [13 13 13]};
