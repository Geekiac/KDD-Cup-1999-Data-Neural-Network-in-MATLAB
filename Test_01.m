% Test_01.m
% Results_01.mat - Workspace variables generated by this experiment
%
% Variable parameters settings compared using this test:
%
% hidden layer transfer functions = all 15 possible functions
% normalizing functions - mapminmax and mapstd
%
% Fixed parameters for this test:
%
% target dataset size for experiment = 10000 (May be less due to rounding)
% network topology - 4 hidden layers containing 10 neurons each
...
epochs = 250; % a maximum of 250 epochs will be allowed for training
